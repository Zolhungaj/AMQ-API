...
public enum CommandTypeOld {
    ...
    private static final Map<String, CommandTypeOld> map = new HashMap<>();
    static {
        for(CommandTypeOld c : CommandTypeOld.values()){
            map.put(c.commandName, c);
        }
    }
    public static CommandTypeOld forName(String commandName){
        return map.get(commandName);
    }
    CommandTypeOld(String commandName){
